...
/* harmony import */ var _ShopList_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ShopList.css */ "./resources/js/src/components/shopList/ShopList.css");
/* harmony import */ var _ShopList_css__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_ShopList_css__WEBPACK_IMPORTED_MODULE_3__);
...
function (_Component) {
  ...
  function ShopList() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getProductsByDesc", function () {
      axios.get("/api/productbypricedesc").then(function (response) {
        //handle success
        _this.setState({
          list: response.data
        });
    ...
    _defineProperty(_assertThisInitialized(_this), "getProductsByAsc", function () {
      axios.get("/api/productbypriceasc").then(function (response) {
        //handle success
        _this.setState({
          list: response.data
        });
  ...
  _createClass(ShopList, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        "aria-hidden": "true"
      }), " ", "\u0414\u0438\u0442\u044F\u0447\u0456")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", null, "\u0411\u0440\u0435\u043D\u0434"), producerfilter, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", null, "\u0422\u0438\u043F"), typefilter), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-10"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
